...
# Data write to Sheet 2


def everyNextWeekSheetWriting(data):
    validateSheet()
    try:
        service = build('sheets', 'v4', credentials=creds)
        sheet = service.spreadsheets()
...
# Data write to Sheet 3

def adhocDataInsert(data):
    validateSheet()
    try:
        service = build('sheets', 'v4', credentials=creds)
        sheet = service.spreadsheets()
